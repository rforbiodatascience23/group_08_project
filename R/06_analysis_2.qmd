...
# the three lines below make use of some base R as the transformation form igraph object to tibble, to use tidyverse functions, and back to igraph object was not working.
graph_pCR_1_filtered <- relevance_filtering(
  graph_pCR, 
  0.8) # 0.8 is a standard valu inn this case but it is not a fixed value
...
graph_nonpCR_1_filtered <- relevance_filtering(
  graph_nonpCR, 
  0.8)
