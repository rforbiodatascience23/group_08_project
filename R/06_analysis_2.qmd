...
lapply(nonpCR_subcommunities, create_and_save_graph_for_community, community = communities_nonpCR, type = "nonpCR", seed = GSE182951_diff_nonpCR_pre_post_genes , output_dir = output_dir)

# Apply the function to each element of pCR_subcommunities
lapply(pCR_subcommunities, create_and_save_graph_for_community, community = communities_pCR, type = "pCR", seed = GSE182951_diff_nonpCR_pre_post_genes, output_dir = output_dir)
...
ora_results_list_nonpCR <- list()
ora_results_list_pCR <- list()

# Loop for communities_pCR
for (i in pCR_subcommunities) {
  results_list_pCR[[str_c("ORA_", i, "_community")]] <- fora(
...
for (i in nonpCR_subcommunities) {
  results_list_nonpCR[[str_c("ORA_", i, "_community")]] <- fora(
    pathways = biological_process_list, 
