...
2.  **Reshape full_expression_data**
    ...
    #Set row names as gene names (it's essential for DESeq())
    rownames(GSE182951) <- GSE182951$Gene

    #Then just delete "Gene" column because we only need the expression value
    GSE182951 <- GSE182951[, -1] 
    ```
...
3.  **Differential expression analysis**
    ...
    GSE182951_diffGenes_pCR_pre_post <- GSE182951_pCR |>
      ...
      filter(log2FoldChange > 1 | log2FoldChange < -1) |> rownames()
