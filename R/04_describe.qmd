...
full_expression_data |>
  ...
  mutate(Treatment = case_when(Sample %% 2 == 0  ~ "Post-treatment", #even
                               Sample %% 2 !=0 ~ "Pre-treatment")) #odd
```
...
figure2 <- full_expression_data |>
  ...
  labs(x = "Samples",
       y = "Average Counts",
       title = "The Average Total Count in Samples by Treatment",
       legend = "Treatment")
...
p3 <- full_expression_data |>
  ...
  labs(x ="Genes",
       y = "Total Counts",
       title = "A Pre-treatment Sample of pCR Patient_12 filterd by 500 > Counts")
...
p4 <- full_expression_data |>
  ...
  labs(x ="Genes",
       y = "Total Counts",
       title = "A Post-treatment Sample of pCR Patient_12 filterd by 500 > Counts")
